...
import com.google.devcoin.script.ScriptOpCodes;
...
import static com.google.devcoin.core.Utils.COIN;
...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            //
            //   "The Times web front page 22-Jul-2011 Europe hails 'historic' deal to save single currency";
            byte[] bytes = Hex.decode
                    ("04ffff001d01044c595468652054696d6573207765622066726f6e7420706167652032322d4a756c2d32303131204575726f7065206861696c732027686973746f72696327206465616c20746f20736176652073696e676c652063757272656e6379");
     ...
     */
    public static final int BIP16_ENFORCE_TIME = 1377993600;

    /**
     * The maximum money to be generated
     */
    public static final BigInteger MAX_MONEY = new BigInteger("21000000000", 10).multiply(COIN);
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.devcoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.devcoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.devcoin.core.AlertMessage}s. You can use {@link com.google.devcoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
