...
public class Peer {
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) throws IOException {
        ...
        log.info("{}: blockChainDownloadLocked({}) current head = {}", new Object[]{toString(),
     ...
     * Once the pong is received the value returned by {@link com.google.devcoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.devcoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.devcoin.core.Peer#ping()} has never
