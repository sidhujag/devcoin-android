...
import com.google.devcoin.core.WalletTransaction.Pool;
...
import com.google.devcoin.wallet.KeyTimeCoinSelector;
...
import org.devcoinj.wallet.Protos.Wallet.EncryptionType;
...
import static com.google.devcoin.core.Utils.bitcoinValueToFriendlyString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.devcoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.devcoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.devcoin.core.Wallet.SendRequest)} is called, this is set to the
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.devcoin.wallet.WalletFiles.Listener)}
     ...
     * {@link com.google.devcoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.devcoin.crypto.KeyCrypter,
     ...
     * {@link com.google.devcoin.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.devcoin.crypto.KeyCrypter,
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.devcoin.core.TransactionBroadcaster broadcaster) {
        lock.lock();
        try {
