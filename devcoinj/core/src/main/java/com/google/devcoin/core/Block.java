...
import static com.google.devcoin.core.Utils.doubleDigest;
import static com.google.devcoin.core.Utils.doubleDigestTwoBuffers;
...
public class Block extends Message {
     ...
     *
     * <p>The half-life is controlled by {@link com.google.devcoin.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    public BigInteger getBlockInflation(int height) {
        return Utils.toNanoCoins(50000, 0);
    }
    ...
    protected boolean checkProofOfWork(boolean throwException) throws VerificationException {
        ...
        BigInteger hash;
        // merged-mined
        if(time >= BlockMergeMined.DEVCOIN_MERGED_MINE_START_TIME)
        {
        ...
        {
            if(mmBlock != null && mmBlock.IsValid())
                throw new VerificationException("Merged-mine block was found before merged-mining was turned on at time: " + BlockMergeMined.DEVCOIN_MERGED_MINE_START_TIME + "(Block 25000)");
            hash = getHash().toBigInteger();
        }
     ...
     * {@link com.google.devcoin.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
