...
package com.google.devcoin.store;
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.devcoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.devcoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
