...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "devcoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;
	...
	public static final String MIMETYPE_TRANSACTION = "application/x-dvctx";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "Devcoin Wallet";
	...
	public static final String CURRENCY_CODE_BTC = "DVC";
	public static final String CURRENCY_CODE_MBTC = "mDVC";
	...
	public static final String PREFS_DEFAULT_BTC_PRECISION = "2";
